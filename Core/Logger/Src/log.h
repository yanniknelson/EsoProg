...
#define LOG(loggerName, level, msg, ...)                                                                                                  \
    ...
    {                                                                                                                                     \
        spdlog::get(loggerName)->log(spdlog::source_loc{ __FILE__, __LINE__, SPDLOG_FUNCTION }, level, fmt::runtime(msg), ##__VA_ARGS__); \
    }                                                                                                                                     \
    else                                                                                                                                  \
    {                                                                                                                                     \
        std::cout << "Tried to log with " << loggerName << " before initializing" << std::endl;                                           \
        BREAK;                                                                                                                            \
    }
...
#define LOG_FATAL(loggerName, ...)                               \
    do                                                           \
    {                                                            \
        LOG(loggerName, spdlog::level::critical, ##__VA_ARGS__); \
        BREAK;                                                   \
    } while (false)
#else
