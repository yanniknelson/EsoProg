...
class PietImageTokeniser : public ITokeniser<PietToken>
{
  public:
    ...
    static const char* i_directionStrings[static_cast<int>(Direction::Count) + 1];
    static const char* i_directionIcons[static_cast<int>(Direction::Count) + 1];
	...
	*/
    ...
    struct BlockInfo
    {
        ...
        BlockInfo(CodelInfo* codelInfo = nullptr, Location loc = { 0, 0 }, Direction directionPointer = Direction::Right, Direction codelChooser = Direction::Left)
            : m_pCodelInfo(codelInfo), m_startingDirectionPointer(directionPointer), m_endingDirectionPointer(directionPointer), m_startingCodelChooser(codelChooser), m_endingCodelChooser(codelChooser), m_startingCodel(loc), m_leavingCodel(loc), m_endingCodel(loc)
        {
        }

        BlockInfo(const BlockInfo& rOther)
            : m_pCodelInfo(rOther.m_pCodelInfo), m_startingDirectionPointer(rOther.m_startingDirectionPointer), m_endingDirectionPointer(rOther.m_endingDirectionPointer), m_startingCodelChooser(rOther.m_startingCodelChooser), m_endingCodelChooser(rOther.m_endingCodelChooser), m_startingCodel(rOther.m_startingCodel), m_leavingCodel(rOther.m_leavingCodel), m_endingCodel(rOther.m_endingCodel)
        {
        }
