...
group "Core/Common/Parser"
	include "Core/ITokeniser/Build-ITokeniser.lua"
	include "Core/IRuntime/Build-IRuntime.lua"
	include "Core/IStack/Build-IStack.lua"
	include "Core/IMemoryArray/Build-IMemoryArray.lua"
	include "Core/IAbstractSyntaxTree/Build-IAbstractSyntaxTree.lua"
	include "Core/IParser/Build-IParser.lua"
group "Core/Common"
...
group "Core/LanguageInterpreters"
	include "Core/PietInterpreter/Build-PietInterpreter.lua"
	include "Core/BrainFckInterpreter/Build-BrainFckInterpreter.lua"
group "App"
