...
char* PietImageTokeniser::i_directionIcons[static_cast<int>(Direction::Count) + 1] = { ICON_FA_ARROW_UP, ICON_FA_ARROW_DOWN, ICON_FA_ARROW_LEFT, ICON_FA_ARROW_RIGHT, "Invalid"};
